...
import { Plus, ShieldCheck, AlertTriangle, BadgeCheck, LayoutGrid, Network } from "lucide-react";
...
export default function SupplyChain() {
  ...
  const [view, setView] = useState("graph"); // graph | grid
